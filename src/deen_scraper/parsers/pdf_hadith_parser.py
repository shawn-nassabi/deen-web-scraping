...
# Default output directory for parsed CSVs (overridable via --output-dir)
DEFAULT_OUTPUT_DIR = Path(__file__).resolve().parents[3] / "data" / "raw" / "shia" / "man-la-yahduruhu-al-faqih" / "csv"
